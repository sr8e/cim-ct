...
class FileOpenFrame(ttk.Frame):
    def __init__(self, master, **kw):
        ...
        radio_s0 = ttk.Radiobutton(frame_in_1, text='フォルダ選択', value=1, variable=self.stype)
        radio_s1 = ttk.Radiobutton(frame_in_2, text='ファイル選択', value=0, variable=self.stype)

        radio_s0.pack(side=tk.LEFT)
        radio_s1.pack(side=tk.LEFT)
